...
/**
 * @ORM\Entity(repositoryClass=LotGlycerineRepository::class)
 */
class LotGlycerine
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=LotQuantite::class, mappedBy="lotGlycerine")
     */
    ...
    public function addLotQuantite(LotQuantite $lotQuantite): self
    {
        if (!$this->lotQuantites->contains($lotQuantite)) {
            ...
            $lotQuantite->setLotGlycerine($this);
        }
    ...
    public function removeLotQuantite(LotQuantite $lotQuantite): self
    {
        if ($this->lotQuantites->removeElement($lotQuantite)) {
            ...
            if ($lotQuantite->getLotGlycerine() === $this) {
                $lotQuantite->setLotGlycerine(null);
            }
        }

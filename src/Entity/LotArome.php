...
/**
 * @ORM\Entity(repositoryClass=LotAromeRepository::class)
 */
class LotArome
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=LotQuantite::class, mappedBy="lotArome")
     */
    ...
    public function removeLotQuantite(LotQuantite $lotQuantite): self
    {
        if ($this->lotQuantites->removeElement($lotQuantite)) {
            ...
            if ($lotQuantite->getLotArome() === $this) {
                $lotQuantite->setLotArome(null);
            }
        }

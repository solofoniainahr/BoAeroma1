...
/**
 * @ORM\Entity(repositoryClass=LotIsolatRepository::class)
 */
class LotIsolat
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=LotQuantite::class, mappedBy="lotIsolat")
     */
    ...
    public function removeLotQuantite(LotQuantite $lotQuantite): self
    {
        if ($this->lotQuantites->removeElement($lotQuantite)) {
            ...
            if ($lotQuantite->getLotIsolat() === $this) {
                $lotQuantite->setLotIsolat(null);
            }
        }
